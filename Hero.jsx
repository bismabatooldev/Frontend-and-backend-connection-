...
const Hero = () => {
 ...
 <div className="box">
  <span />
  <div className="content"><img src="/public/hero.webp" className="d-block mx-lg-auto img-fluid alots" alt="Bootstrap Themes" width={700} height={500} loading="lazy" /></div>
</div>
      ...
      <div className="col-lg-6 lol">
        ...
        <h1 className="display-5 fw-bold lh-1 mb-3">From Dawn Till Dusk</h1>
        <p>
        Rs.5,399.00 PKR
        </p>
